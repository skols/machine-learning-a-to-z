...
setwd("C:/Development/Courses/Kirill Eremenko Data Science Courses/Machine_Learning_A-Z/Part9_Dimensionality_Reduction/Section36_Kernel_PCA")
...
prob_pred <- predict(classifier, type="response", newdata=test_set_pca[-3])  # remove last column of test set
